...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 >Chat Room | <a href="view_your_query_reply.php">Go Back </a></h1>
    </div>
	...
	<div class="chatbox">
			<?php
				...
				<span class="sender_name"><?php $SENDERID=$fetching[sender_id];?>
								...
								Hello <?php echo $fetching_name['name'];?> Your Msg Was :
...
<hr>
			...
			<form action="view_response_action.php" method="post">					
			<span class="mytext"><div class="mycontainer_response"><textarea rows="3" cols="40" name="reply" > </textarea></div>
